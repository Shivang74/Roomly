...
const RoomSearch = ({ handleSearchResult }) => {
  ...
  const handleInternalSearch = async () => {
    ...
    try {
      ...
      /* toISOString() converts the date to the format: YYYY-MM-DDTHH:mm:ss.sssZ.
         .split('T')[0]: This splits the string at the 'T' (which separates the date and time), and [0] takes only the date part (YYYY-MM-DD).
         If no startDate or endDate is provided, it sets them to null
        */
