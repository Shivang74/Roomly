...
const HomePage = () => {
    ...
    return (
        <div className="home">
            ...
            <section>
                <header className="header-banner">
                    ...
                    <div className="animated-texts overlay-content">
                        <h1>
                            Welcome to <span className="phegon-color">Roomlyl</span>
                        </h1><br />
                        <h3>Welcome to the Paradise of Comfort and Care!</h3>
                    </div>
                </header>
            </section>
            ...
            <h2 className="home-services">Services at <span className="phegon-color">Roomly</span></h2>
